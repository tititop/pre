...
template <typename T> struct isMessage {
    enum { YES = 1, WRITE_TYPE = WT_LENGTH_DELIMITED };
};
template<> struct isMessage<std::string> {
    enum { YES = 0, WRITE_TYPE = WT_LENGTH_DELIMITED };
};
template<> struct isMessage<bool> {
    enum { YES = 0, WRITE_TYPE = WT_VARINT };
};
template<> struct isMessage<int32_t> {
    enum { YES = 0, WRITE_TYPE = WT_VARINT };
};
template<> struct isMessage<uint32_t> {
    enum { YES = 0, WRITE_TYPE = WT_VARINT };
};
template<> struct isMessage<int64_t> {
    enum { YES = 0, WRITE_TYPE = WT_VARINT };
};
template<> struct isMessage<uint64_t> {
    enum { YES = 0, WRITE_TYPE = WT_VARINT };
};
template<> struct isMessage<float> {
    enum { YES = 0, WRITE_TYPE = WT_32BIT };
};
template<> struct isMessage<double> {
...
template<> struct type<bool> {
    static inline bool strto(const char* str)
    {
        return atoi(str) != 0;
    }
    static inline std::string tostr(bool v)
    {
        return v ? "1" : "0";
    }
};
...
template<> struct type<int32_t> {
    static inline int32_t strto(const char* str)
    {
        return (int32_t)atoi(str);
    }
    static inline std::string tostr(int32_t v)
    {
        char szTransbuf[_RTBUFSIZE] = { 0 };
        sprintf(szTransbuf, "%d", v);
        return szTransbuf;
    }
};
//uint32_t
template<> struct type<uint32_t> {
    ...
    {
        char szTransbuf[_RTBUFSIZE] = { 0 };
        sprintf(szTransbuf, "%u", v);
        return szTransbuf;
    }
};
//int64_t
template<> struct type<int64_t> {
    static inline int64_t strto(const char* str)
    {
        return _atoi64(str);
    }
    ...
    {
        char szTransbuf[_RTBUFSIZE] = { 0 };
        sprintf(szTransbuf, "%lld", (long long)v);
        return szTransbuf;
    }
};
//uint64_t
...
template<> struct type<float> {
    static inline float strto(const char* str)
    {
        return (float)atof(str);
    }
    static inline std::string tostr(float v)
    {
        char szTransbuf[_RTBUFSIZE] = { 0 };
        sprintf(szTransbuf, "%f", v);
        return szTransbuf;
    }
};
//double
template<> struct type<double> {
    ...
    static inline std::string tostr(double v)
    {
        char szTransbuf[_RTBUFSIZE] = { 0 };
        sprintf(szTransbuf, "%lf", v);
        return szTransbuf;
    }
};
//char*
template<> struct type<char*> {
    static inline char* strto(char* str)
    {
        return str;
    }
    static inline std::string tostr(char* v)
    {
        return v;
    }
};
...
template<> struct type<const char*> {
    static inline const char* strto(const char* str)
    {
        return str;
    }
    static inline std::string tostr(const char* v)
    {
        return v;
    }
};
...
template<> struct type<std::string> {
    ...
    static inline std::string tostr(const std::string& v)
    {
        return v.c_str();
    }
};
